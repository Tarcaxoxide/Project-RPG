...
func _ready():
	...
	Data["Level"]["Options"].append(_NewOption("Continue","res://Scenes/Levels/L4D.tscn"))
	#Data["Level"]["Options"].append(_NewOption("Backward","res://Scenes/Levels/L4B.tscn"))
	#Data["Level"]["Options"].append(_NewOption("Forward","res://Scenes/Levels/L4D.tscn"))
	_prep_ready(Data)
