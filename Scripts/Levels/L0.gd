...
func _ready():
	...
	Data["Level"]["Options"].append(_NewOption("Continue","res://Scenes/Levels/L1.tscn"))
	#Data["Level"]["Options"].append(_NewOption("Forward","res://Scenes/Levels/L1.tscn"))
	#Data["Level"]["Options"].append(_NewOption("Backward","res://Scenes/Levels/L-1.tscn"))
	_prep_ready(Data)
