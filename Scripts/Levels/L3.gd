...
func _ready():
	Data["Level"]["Current Scene"]="L3"
	Data["Level"]["Options"].append(_NewOption("Continue","res://Scenes/Levels/L4A.tscn"))
	#Data["Level"]["Options"].append(_NewOption("Forward","res://Scenes/Levels/L4A.tscn"))
	#Data["Level"]["Options"].append(_NewOption("Backward","res://Scenes/Levels/L2.tscn"))
	_prep_ready(Data)
